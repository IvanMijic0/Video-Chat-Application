            ...
            <div class="h-full overflow-hidden">
                <div class="flex justify-between items-center border-b">
                    ...
                    <div class="flex items-center mx-4">
                        ...
                        <span class="select-none transition hover:text-gray-500 mx-3 text-gray-600 cursor-pointer"><i
                                    class="fas fa-comment-alt"></i></span>
                        <span class="menu-logout relative select-none transition hover:text-gray-500 mx-3 text-gray-600 cursor-pointer"><i
