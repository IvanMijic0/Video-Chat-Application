                    ...
                    <div class="right-heading w-full flex flex-col items-center">
                        ...
                        <form method="post" class="w-full">
                            <div class="w-full flex flex-col items-center">
                                ...
                                <div>
                                    <button class="active:-top-2 relative transition border border-gray-400 shadow-md my-4 bg-green-400 hover:bg-green-500 p-2 px-20 rounded-full text-white text-xl">
                                        Login
                                    </button>
                                </div>
                            </div>
